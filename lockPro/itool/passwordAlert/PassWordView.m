...
-(void)setViews
{
    ...
    self.textView.layer.shadowColor = COLOR(245, 245, 245).CGColor;
    self.textView.layer.shadowOffset = CGSizeMake(0, 0);
    self.textView.layer.shadowOpacity = 0.2;
    self.textView.layer.shadowRadius = 4;
    
    
    self.titleLabel.frame = CGRectMake(0, 14, self.textView.frame.size.width, 20);
    ...
    self.cancelBtn.backgroundColor =COLOR(245, 245, 245);
    self.cancelBtn.titleLabel.font = [UIFont fontWithName:@"STHeitiSC-Light" size:self.cancelBtn.frame.size.height/3];
    [self.cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [self.cancelBtn setTitleColor:COLOR(173, 173, 173) forState:UIControlStateNormal];
    ...
    self.confirmBtn.backgroundColor = COLOR(245, 245, 245);
    [self.confirmBtn setTitleColor:COLOR(79, 190, 140) forState:UIControlStateNormal];
    ...
    self.passWordCollectionV.layer.borderColor = COLOR(245, 245, 245).CGColor;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PassWordCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
     ...
     if (indexPath.row <= self.textArr.count - 1) {
        cell.circleImageV.backgroundColor = COLOR(245, 245, 245);
    }else{
        cell.circleImageV.backgroundColor = [UIColor whiteColor];
    }
